...
*WhatsApp-style iOS messenger with AI agent for busy parents*

iOS messaging app built for busy parents drowning in group chats. A unified AI agent automatically extracts calendar events, deadlines, RSVPs, and priority messages from conversations. Features conflict detection against device calendar and semantic search via RAG.

---

### [CanvasIQ](https://github.com/karinje/collab-canvas)
*Figma-meets-ChatGPT collaborative whiteboard with voice/text commands*
...
*Autonomous QA agent that plays and scores browser games using LLMs*
...
*AI math tutor that teaches through questions, not answers*
...
*Desktop video editor with screen recording and PiP composition*
...
### Metriq
*Cursor for data scientists and analysts*

AI-native IDE built on JupyterLab with MCP tools and LangGraph agents. Integrates databases, dashboards, and external systems, eliminating fragmented context across tools and turning analyses into repeatable recipes with memory.
...
[Portfolio](https://sanjaykarinje.dev/) • [LinkedIn](https://www.linkedin.com/in/sanjay-karinje-8a32702b)
